    ...
    return (
        <div className="p-3">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Ada taxi, the software program provided by the Company.
                    </p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the
                        Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
                        Ada taxi, Uzbekistan.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Ada taxi, accessible from <a href="https://adataxi.uz/"
                                                                                       rel="external nofollow noopener"
                                                                                       target="_blank">https://adataxi.uz/</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By phone number: +998 91 544 44 99</li>
            </ul>
        </div>
    );
}
